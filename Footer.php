...
?>
	...
	<div class="col-sm-4 text-justify">
     ...
     <center><img src="image/devlop/img3.png"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color: #b2ff00;height:40px;padding-top:10px;color:black;">
  <p>Copyright &copy; Grand StopOver. All Rights Reserved</p>
</footer>