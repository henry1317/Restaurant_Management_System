...
<body style="margin-top:30px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/Standard Room/Standard_img13.jpg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/Standard Room/Standard_img14.jpg"class="thumbnail" alt="img2">
    </div>

    <div class="item">
       <img src="image/Standard Room/Standard_img15.jpg"class="thumbnail" alt="img3">
    </div>

    <div class="item">
       <img src="image/Standard Room/Standard_img16.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="image/Standard Room/Standard_img17.jpg"class="thumbnail" alt="img5">
    </div>
  </div>
